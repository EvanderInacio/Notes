  ...
  return (
    <div className="h-full flex items-center justify-center mt-14">
      <form className="px-2 flex flex-col justify-center items-center text-center">
        ...
        <h2 className='text-2xl mt-16 mb-6'>Faça seu Login</h2>
        ...
        <a 
          href="#" 
          className='text-orange-800 border-[2px] border-gray-100 rounded-md mt-1 p-2 hover:border-orange-800 brightness-100'
        >
          Criar conta
        </a>
      </form>
